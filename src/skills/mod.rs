...
const OPEN_SKILLS_SYNC_MARKER: &str = ".R.A.I.N.-open-skills-sync";
...
/// Skills live in `~/.R.A.I.N./workspace/skills/<name>/SKILL.md`
...
"#,
    ...
    #[test]
    fn skills_dir_path() {
        let base = std::path::Path::new("/home/user/.R.A.I.N.");
        let dir = skills_dir(base);
        assert_eq!(dir, PathBuf::from("/home/user/.R.A.I.N./skills"));
    }
