...
- variable: `HOMEBREW_CORE_BOT_FORK_REPO` (for example `R.A.I.N.-release-bot/homebrew-core`)
...
- variable: `SCOOP_BUCKET_REPO` (for example `R.A.I.N.-labs/scoop-R.A.I.N.`)

Workflow guardrails:

- release tag must be `vX.Y.Z` format
- Windows binary SHA256 extracted from `SHA256SUMS` release asset
- manifest pushed to `bucket/R.A.I.N..json` in the Scoop bucket repo
...
- PKGBUILD and .SRCINFO pushed to AUR `R.A.I.N.` package
