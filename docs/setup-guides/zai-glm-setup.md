...
R.A.I.N. supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current R.A.I.N. provider behavior.

## Overview

R.A.I.N. supports these Z.AI aliases and endpoints out of the box:
