...
- If identity-like naming is required in tests/examples, use R.A.I.N.-native labels only (`R.A.I.N.Agent`, `R.A.I.N._user`, `R.A.I.N._node`).
...
- If identity-like context is unavoidable, use R.A.I.N.-scoped roles/labels only (for example: `R.A.I.N.Agent`, `R.A.I.N.Operator`, `R.A.I.N._user`) and avoid real-world personas.
- Recommended identity-safe naming palette (use when identity-like context is required):
    - actor labels: `R.A.I.N.Agent`, `R.A.I.N.Operator`, `R.A.I.N.Maintainer`, `R.A.I.N._user`
    - service/runtime labels: `R.A.I.N._bot`, `R.A.I.N._service`, `R.A.I.N._runtime`, `R.A.I.N._node`
    - environment labels: `R.A.I.N._project`, `R.A.I.N._workspace`, `R.A.I.N._channel`
