...
# Target library path - use environment variable or default to parent of current directory
LIBRARY_PATH = os.environ.get("JAMES_LIBRARY_PATH", os.path.dirname(os.path.dirname(__file__)))
