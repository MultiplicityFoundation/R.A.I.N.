...
//!
//! Ref: https://github.com/R.A.I.N.-labs/R.A.I.N./issues/618 (item 6)
...
use rain_labs::providers::{ChatResponse, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: R.A.I.N."));
